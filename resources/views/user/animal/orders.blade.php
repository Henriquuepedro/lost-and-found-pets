                                    ...
                                    <div class="acc-order-container">
                                        <div class="row">
                                            <div class="col-md-12 d-flex justify-content-between flex-wrap align-items-center">
                                                ...
                                                <button class="btn btn-primary mr-0">Novo Registro</button>
                                            </div>
                                        </div>
                                            ...
                                            <div class="acc-delivery-cont acc-delivery-cont-delivered  acc-delivery-cont-close">
                                                <div class="acc-order-header danger acc-animal-header">
                                                    ...
                                                    <div class="acc-order-header-info">
                                                        ...
                                                        <span>
                                                            Registrado em:
                                                            <strong class="acc-delivery-prevision-days delivered">{{ $animal['created_at'] }}</strong>
                                                        </span>
                                                    </div>
                                                </div>
                                                            ...
                                                            <li class="acc-order-item-cont">
                                                                <div class="acc-order-product">
                                                                    <a target="_blank" rel="noopener noreferrer" class="img-product" href="">
                                                                        <figure><img class="acc-order-product-image" src="https://saude.abril.com.br/wp-content/uploads/2020/03/cao-pug.jpg" alt="Sem imagem"></figure>
                                                                    </a>
                                                                    <div class="acc-order-product-truncate">
                                                                    <span class="acc-order-product-info" alt="" title="">
                                                                        <a class="acc-order-product-link" target="_blank" rel="noopener noreferrer" href="">info info info info info info </a>
                                                                    </span>
                                                                        <p class="acc-order-product-info"><strong>info info info info info info </strong></p>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                        </ul>
                                                        <div class="boxBtnAction">
                                                            <a class="btn btn-primary col-md-4 py-1" href="{{ route('user.account.animal', array('id' => 0)) }}">
