...
@section('title', 'Criar Avaliações')

@section('content_header')
    <h1 class="m-0 text-dark">Criar Avaliações</h1>
@stop
        ...
        <div class="col-md-12">
            ...
            <div class="card card-default">
                <div class="card-header">
                    ...
                    <small class="text-danger">Essa avaliação não será vinculada a nenhum pedido</small>
                </div>
                <form action="{{ route('admin.rate.insert') }}" enctype="multipart/form-data" method="POST">
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-md-12">
                                <label for="name">Nome</label>
                                <input type="text" class="form-control" id="name_user" name="name_user" value="{{ old('name_user')  }}" placeholder="Digite o nome do avaliador" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="name">Título</label>
                                <input type="text" class="form-control" id="title" name="title" value="{{ old('title')  }}" placeholder="Digite o título da avaliação" required>
                            </div>
