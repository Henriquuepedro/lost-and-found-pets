...
@section('title', 'Alterar Cupom')

@section('content_header')
    <h1 class="m-0 text-dark">Alterar Cupom</h1>
@stop
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card card-default">
                ...
                <form action="{{ route('admin.coupon.update') }}" enctype="multipart/form-data" method="POST">
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="name">Nome do Cupom</label>
                                <input type="text" class="form-control" id="name" name="name" value="{{ old('name') ?? $dataCoupon['name'] }}" placeholder="Digite o nome do cupom" required>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="date" class="form-control" id="date_exp" name="date_exp" value="{{ old('date_exp') ?? $dataCoupon['date_expired'] }}" placeholder="Digite a data de expiração" required>
                                </div>
                            </div>
                            <div class="form-group col-md-3">
                                <label for="value">Percentual</label>
                                <div class="input-group">
                                    <input type="text" class="form-control" id="percentage" name="percentage" value="{{ old('percentage') ?? $dataCoupon['percentage'] }}" placeholder="Digite o percentual" required>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="checkbox" {{$product['active'] ? 'checked' : ''}} data-bootstrap-switch data-off-color="danger" data-on-color="success" data-on-text="SIM"  data-off-text="NÃO" name="coupon[]" value="{{$product['id']}}">
                            </div>
                            @endforeach
                        </div>
                    </div>
                    ...
                    <input type="hidden" name="coupon_id" value="{{$dataCoupon['id']}}">
                    {!! csrf_field() !!}
                </form>
            </div>
        </div>
