...
@section('content_header')
    <h1 class="m-0 text-dark">Criar Promoção</h1>
@stop
        ...
        <div class="col-md-12">
            ...
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title">Criar Promoção</h3>
                </div>
                <form action="{{ route('admin.promotion.insert') }}" enctype="multipart/form-data" method="POST">
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <select name="type" class="form-control" required>
                                    ...
                                    <option {{ old('type') == 1 ? 'selected' : '' }} value="1">Frete Grátis - Frete menor que X reais</option>
                                    <option {{ old('type') == 2 ? 'selected' : '' }} value="2">Frete Grátis - Pedido maior que X reais (PAC)</option>
                                </select>
                            </div>
                            <div class="form-group col-md-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="value" name="value" value="{{ old('value') }}" placeholder="Digite o valor" required>
                                </div>
                            </div>
                            <div class="form-group col-md-3">
                                <label for="value">Situação</label>
                                <div class="form-group col-md-12">
                                    <input type="checkbox" data-bootstrap-switch data-off-color="danger" data-on-color="success" data-on-text="ATIVO"  data-off-text="INATIVO" name="active" {{ old() ? old('active') == "on" ? 'checked' : '' : 'checked' }}>
                                </div>
                            </div>
                        </div>
                    </div>
