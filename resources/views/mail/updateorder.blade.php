...
@section('body')
    <tr>
        <td style="font-family: 'Microsoft YaHei','Source Sans Pro', sans-serif;font-size:16px;color:rgb(0, 0, 0);text-align:center;line-height:18px;font-weight:bold; text-transform: uppercase; padding-top:20px">Pedido Atualizado!</td>
    </tr>
    <tr>
    ...
    <tr>
        <td style="font-family: 'Microsoft YaHei','Source Sans Pro', sans-serif;font-size:16px;color:#202427; padding-bottom: 10px;">
            O seu pedido #{{ str_pad($order, 5, "0", STR_PAD_LEFT) }} foi atualizado para: <strong>{{ $statusOrder }}</strong>
        </td>
    </tr>
    <tr>
        <td style="font-family: 'Microsoft YaHei','Source Sans Pro', sans-serif;font-size:16px;color:#202427; padding-bottom: 10px;">
